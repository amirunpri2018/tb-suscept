...
\title{Identifying gene regulatory signature in individuals susceptible to tuberculosis }
...
\begin{abstract}
\textbf{Tuberculosis is a deadly infectious disease}\textbf{,}\textbf{
which kills millions of people every year. The causative pathogen,
}\textbf{\emph{Mycobacterium tuberculosis}}\textbf{ (MTB), is
estimated to have infected up to a third of the world’s population;
however, only approximately 10\% of healthy individuals progress to
active TB disease. Despite evidence for heritability, }\textbf{it is
not}\textbf{ currently }\textbf{possible}\textbf{ to predict whether a
healthy person is susceptible to TB. }\textbf{To explore approaches to
classify susceptibility}\textbf{ to TB}\textbf{, w}\textbf{e
}\textbf{infected }\textbf{dendritic cells (DCs) from individuals
known to be susceptible or resistant to TB with MTB, and measured
genome-wide gene expression levels}\textbf{ in infected and uninfected
cells}\textbf{. }\textbf{W}\textbf{e }\textbf{found}\textbf{
}\textbf{that gene expression }\textbf{differences}\textbf{ between
susceptible and resistant individuals }\textbf{were}\textbf{ primarily
present in the non}\textbf{-}\textbf{infected }\textbf{cells}\textbf{.
Intersecting our results with genome wide association analyses (GWAS),
we demonstrated an enrichment of low GWAS p-values for the
differential}\textbf{ly}\textbf{ expressed genes}\textbf{,}\textbf{
and also identified two interesting candidate genes:
}\textbf{\emph{CCL1}}\textbf{ and }\textbf{\emph{UNC13A}}\textbf{.
}\textbf{Lastly, we trained a classifier based on the gene expression
levels in the non}\textbf{-}\textbf{infected state and demonstrated
}\textbf{decent}\textbf{ performance on our data and an independent
data set. Overall, our promising results from this small study suggest
that }\textbf{training a classifier on a larger cohort could enable us
to accurately predict TB susceptibility}\textbf{, which would inform
the prevention and treatment of TB infections}\textbf{.}
\end{abstract}
\begin{document}
\flushbottom
\maketitle
...
organization, e.g. gene regulatory networks. Indeed, a previous study
has successfully identified gene expression differences in innate
...
DE between the non-infected and infected states for resistant
...
individuals in the noninfected state (Fig. \ref{fig:gwas}a). Only 2
...
conducted in Africans. Nevertheless…
...
treat a latent MTB infection \cite{Munoz2015}, false negatives
