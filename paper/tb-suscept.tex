...
presumably to fight the infection. We chose to measure gene expression
...
supervised the project. J.D.B. wrote the paper with input from all
authors.
...
individuals (treat\_suscep). The x- and y-axes are consistent within
each study (row), but differ across studies.
}
\label{fig:gwas-supp}
\end{figure}
