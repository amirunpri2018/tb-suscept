...
\subsection*{Gene expression levels in the non-infected state can predict susceptibility status}
...
considering these limitations, it was encouraging that we were still
able to detect evidence of the genetic basis of TB susceptibility in
this system.
...
(Supplementary Fig. \ref{fig:gwas-supp}) data sets.
