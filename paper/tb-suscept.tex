...
\begin{abstract}
Interestingly, we identified 645 genes which were differentially expressed between susceptible and resistant individuals in the noninfected state, including \emph{ATPV1B2}, \emph{FEZ2}, and \emph{PSMA2}. Furthermore, we found that these differentially expressed genes were enriched for low GWAS p-values and could be used to classify susceptible and resistant individuals.
\end{abstract}
\begin{document}
\flushbottom
\maketitle
