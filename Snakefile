...
rule gwas:
    ...
    output: data + "results-gwas.txt",
            data + "gambia-status_ii-enrichment.txt",
            data + "gambia-status_ii-intervals.txt",
            data + "gambia-status_ii-sizes.txt",
            data + "gambia-status_ni-enrichment.txt",
            data + "gambia-status_ni-intervals.txt",
            data + "gambia-status_ni-sizes.txt",
            data + "gambia-treat_resist-enrichment.txt",
            data + "gambia-treat_resist-intervals.txt",
            data + "gambia-treat_resist-sizes.txt",
            data + "gambia-treat_suscep-enrichment.txt",
            data + "gambia-treat_suscep-intervals.txt",
            data + "gambia-treat_suscep-sizes.txt",
            data + "ghana-status_ii-enrichment.txt",
            data + "ghana-status_ii-intervals.txt",
            data + "ghana-status_ii-sizes.txt",
            data + "ghana-status_ni-enrichment.txt",
            data + "ghana-status_ni-intervals.txt",
            data + "ghana-status_ni-sizes.txt",
            data + "ghana-treat_resist-enrichment.txt",
            data + "ghana-treat_resist-intervals.txt",
            data + "ghana-treat_resist-sizes.txt",
            data + "ghana-treat_suscep-enrichment.txt",
            data + "ghana-treat_suscep-intervals.txt",
            data + "ghana-treat_suscep-sizes.txt"
    shell: "Rscript {input.script} {data}"
...
rule create_figures:
    input: data +  "cpm-all.rds",
           ...
           explained = data + "results-pca-explained.rds",
           covariates = data + "results-pca-covariates.txt",
           gwas01 = data + "gambia-status_ii-enrichment.txt",
           gwas02 = data + "gambia-status_ni-enrichment.txt",
           gwas03 = data + "gambia-status_ni-intervals.txt",
           gwas04 = data + "gambia-status_ni-sizes.txt",
           gwas05 = data + "gambia-treat_resist-enrichment.txt",
           gwas06 = data + "gambia-treat_suscep-enrichment.txt",
           gwas07 = data + "ghana-status_ii-enrichment.txt",
           gwas08 = data + "ghana-status_ni-enrichment.txt",
           gwas09 = data + "ghana-status_ni-intervals.txt",
           gwas10 = data + "ghana-status_ni-sizes.txt",
           gwas11 = data + "ghana-treat_resist-enrichment.txt",
           gwas12 = data + "ghana-treat_suscep-enrichment.txt",
