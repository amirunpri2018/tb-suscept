...
f_tpm <- args[2]
files <- args[-1:-2]
# files <- c("/project/gilad/jdblischak/tb-suscept/kallisto/15-contact-infected-HCMF5BBXX-l4/abundance.tsv",
#            "/project/gilad/jdblischak/tb-suscept/kallisto/15-contact-none-HCMF5BBXX-l4/abundance.tsv",
#            "/project/gilad/jdblischak/tb-suscept/kallisto/14-contact-infected-HCMF5BBXX-l4/abundance.tsv",
#            "/project/gilad/jdblischak/tb-suscept/kallisto/14-contact-none-HCMF5BBXX-l4/abundance.tsv")
