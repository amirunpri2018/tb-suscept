...
```{r input-ash}
ash_treatment <- readRDS("../data/results-ash-treatment.rds")
ash_status <- readRDS("../data/results-ash-status.rds")
ash_interaction <- readRDS("../data/results-ash-interaction.rds")
```
...
```{r}
genes_for_classifer <- v$E[ash_status$svalue < .05 |
                           ash_interaction$svalue < .05, ]
