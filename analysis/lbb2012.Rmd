...
plot(density(rnaseq_medians_qq))
...
g <- rownames(training)[results[["diff_before"]]$svalue < .05 &
                        results[["study_before"]]$svalue > .05]
length(g)
